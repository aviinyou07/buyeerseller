...
const SectionCard = ({ title, children }) => {
  ...
  return (
    <section className="space-y-2.5 pt-2">
      <h2 className="px-1 text-[13px] font-semibold uppercase tracking-wide text-slate-700">
...
const MenuRow = ({ item, onClick }) => {
  ...
  return (
    ...
    >
      ...
      {item.badge && (
        <span className="inline-flex shrink-0 items-center gap-1 rounded-full bg-[#f1efff] px-2 py-1 text-[11px] font-semibold text-[#4d49b9]">
            ...
            {data.items.length > 0 ? data.items.map((item) => (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  {item.meta && (
                    <span className="shrink-0 rounded-full bg-[#f1efff] px-2.5 py-1 text-[11px] font-semibold text-[#4d49b9]">
    ...
    <div className="flex w-full items-center justify-between gap-3 border-b border-slate-100/70 bg-white px-3.5 py-3.5 text-left">
      ...
      <div className="grid grid-cols-2 overflow-hidden rounded-full bg-slate-100 p-1 ring-1 ring-slate-200">
        {options.map((option) => {
          ...
          return (
            <button
              className={`h-8 min-w-12 rounded-full px-3 text-xs font-semibold transition ${
                isActive
          ...
          <div className="relative flex items-center gap-4 text-left">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex justify-between items-start gap-2">
                <div className="min-w-0">
                  <h2 className="truncate text-[17px] font-semibold tracking-normal text-[slate-900]">
                    {displayName}
                  </h2>
                  {displayEmail && (
                ...
                {!isEditing && (
                  <button
                    ...
                    className="text-[11px] font-medium text-[#4d49b9] bg-transparent px-2 sm:px-3 py-1.5 sm:py-1 rounded-full ring-1 ring-[#4d49b9] transition-all shrink-0 mt-0.5 flex items-center gap-1.5"
                  >
            ...
            {isEditLoading ? (
              ...
              <form onSubmit={handleEditSubmit} className="p-4 space-y-4 text-left">
                <div className="space-y-1">
                  <label className="text-xs font-medium text-slate-700">{translateProfileText("Full Name", language)} *</label>
                ...
                <div className="space-y-1">
                  <label className="text-xs font-medium text-slate-700">{translateProfileText("Email", language)} *</label>
                ...
                <div className="space-y-1">
                  <label className="text-xs font-medium text-slate-700">{translateProfileText("Phone Number", language)} *</label>
                ...
                <div className="space-y-1">
                  <label className="text-xs font-medium text-slate-700">{translateProfileText("Address", language)} *</label>
                ...
                <div className="space-y-1">
                  <label className="text-xs font-medium text-slate-700">{translateProfileText("Business Name (Optional)", language)}</label>
                ...
                <div className="space-y-1">
                  <label className="text-xs font-medium text-slate-700">{translateProfileText("GST Number (Optional)", language)}</label>
                ...
                <div className="flex gap-2 pt-2">
                  <button type="button" onClick={() => setIsEditing(false)} className="flex-1 py-2 text-sm font-medium text-slate-600 bg-slate-100 rounded-md hover:bg-slate-200">
                    {translateProfileText("Cancel", language)}
                  </button>
                  <button type="submit" className="flex-1 py-2 text-sm font-medium text-white bg-gradient-to-r from-indigo-600 to-purple-600 rounded-md shadow-sm shadow-indigo-200 transition hover:opacity-90 active:scale-95">
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="shrink-0 text-right">
                        ...
                        <span className="mt-1 inline-flex rounded-full bg-[#f1efff] px-2.5 py-1 text-[11px] font-semibold text-[#4d49b9]">
                          {translateProfileText(
